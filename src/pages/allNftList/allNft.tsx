...
const AllNft: React.FunctionComponent<AllNftProps> = (props) => {
  const { imageAddress, openModel, setOpenModel, nftOwner, nftNumber, nftLevel, nftPrice } = props;
  const equipNft = () => {
    console.log("hi");
  };
  return (
    <>
      ...
      <div className="myNftList">
        ...
        <div className="myNftDescription">
          ...
          <div className="myNftPrice">${nftPrice} SIGNA</div>
        </div>
        <div className="myNftBottom">
          ...
          <>
            <button className="myNftButton" onClick={equipNft}>
              AVALIBLE
            </button>
            <img
              onClick={() => {
