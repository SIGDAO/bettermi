...
const cardContent = missionList.map((mission) => (
  <div className="challenge-cards-Ic1qil">
    ...
    <a href="bettermidapp-challenges-countdown-1.html">
    ...
    <img className="nft_-avatar" src="img/nft-avatar@1x.png" alt="NFT_Avatar" />
    <div className="durations">
      <div className="x3-mins inter-semi-bold-cadet-blue-14px">3 mins</div>
      <img className="ic_time" src="img/ic-time@1x.png" alt="ic_time" />
    </div>
    <div className="body-parts">
      <img className="ic_-body" src="img/ic-body@1x.png" alt="ic_Body" />
    ...
    <div className="sigdao-score">
      ...
      <div className="signdao_tokengradient">
        ...
        <img className="x880" src="img/file---880-1x-png-10@1x.png" alt="880" />
      </div>
    </div>
    ...
    <img className="seperate-line" src="img/seperate-line-1@1x.png" alt="seperate line" />
  </div>
...
const MissionChallenge: React.FunctionComponent<IMissionChallengeProps> = (props) => {
  ...
  const content: JSX.Element = (
    <div className="bettermidapp-challenges-1 screen">
      ...
      <img className="bg-7K5ObS bg" src="img/bg-10@1x.png" alt="BG" />
      <img className="photo-7K5ObS" src="img/photo@1x.png" alt="Photo" />
      <div className="challenges-card-7K5ObS">
        <img className="layer-nLfc9z" src="img/layer-1@1x.png" alt="Layer" />
      ...
      <div className="ic_help_24px-7K5ObS ic_help_24px">
        <img className="ic_help_24px-pqAZxK ic_help_24px" src="img/ic-help-24px-1@1x.png" alt="ic_help_24px" />
      </div>
    </div>
  )
  return (
