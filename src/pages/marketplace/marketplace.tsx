        ...
        <div className="partner-company-Rea9Nd partner-company">
          ...
          <div className="special-scroll-AStx0d">
            <div className="x25-Wx9nPx">
              ...
              <div className="x1-Y63lEW x1"><img className="x1-0pT4eI x1" src={`${process.env.PUBLIC_URL}/img/marketplace/1@1x.png`} alt="1" /></div>
              <div className="x2-Y63lEW"><img className="x1-EMGmsF x1" src={`${process.env.PUBLIC_URL}/img/marketplace/1@1x.png`} alt="1" /></div>
            </div>
          </div>
        </div>
        <MenuBar/>
