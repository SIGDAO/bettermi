    ...
    <ShortTitleBar title="Marketplace" />
      <div className="bettermidapp-mimi-nfts-1 screen">
        ...
        <div className="bars-status-bar-i-phone-light-ipEwgj bars-status-bar-i-phone-light">
          ...
          <div className="status-bar">
            {/* <div className="battery">
              ...
              <img className="cap" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/cap-10@1x.png`} alt="Cap" />
              <div className="capacity"></div>
            </div> */}
            {/* <img className="wifi" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/wifi-10@1x.png`} alt="Wifi" />
            <img className="cellular-connection" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/cellular-connection-10@1x.png`} alt="Cellular Connection" />
        ...
        <div className="scroll-nft-card-ipEwgj">
          <div className="repeated-nft-card-19dZDf">
            <div className="x16217-VwzVjk x16217">
              <img className="nft-box" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/nft-box@1x.png`} alt="NFT box" />
              <img className="nft" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/nft-1@1x.png`} alt="NFT" />
              ...
              <img className="seperate-line" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/seperate-line-1@1x.png`} alt="seperate line" />
              <div className="ic_send-DhT6v2 ic_send">
                <img className="ic_send-USHlN8 ic_send" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/ic-send@1x.png`} alt="ic_send" />
              </div>
            ...
            <div className="x16217-ssUnfI x16217">
              ...
              <div className="ic_send-jxGQtF ic_send">
                <img className="ic_send-CdJede ic_send" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/ic-send@1x.png`} alt="ic_send" />
              </div>
              <div className="button_nft_-equip">
            ...
            <div className="x16217-4iQVot x16217">
              ...
              <div className="ic_send-ImTyxU ic_send">
                <img className="ic_send-6aXymi ic_send" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/ic-send@1x.png`} alt="ic_send" />
              </div>
              <div className="button_nft_-equip">
            ...
            <div className="x16217-vaxOuK x16217">
              ...
              <div className="ic_send-CEvQNx ic_send">
                <img className="ic_send-QzS03L ic_send" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/ic-send@1x.png`} alt="ic_send" />
              </div>
              <div className="button_nft_-equip">
            ...
            <div className="x16217-e5wAUf x16217">
              ...
              <div className="ic_send-VTGvEh ic_send">
                <img className="ic_send-RWwapn ic_send" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/ic-send@1x.png`} alt="ic_send" />
              </div>
              <div className="button_nft_-equip">
            ...
            <div className="x16217-IgZtda x16217">
              ...
              <div className="ic_send-aVD1X9 ic_send">
                <img className="ic_send-BnGgTr ic_send" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/ic-send@1x.png`} alt="ic_send" />
              </div>
              <div className="button_nft_-equip">
        ...
        {/* <div className="title-bar-ipEwgj">
          <img className="bg-efxqDX bg" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/bg-11@1x.png`} alt="BG" />
          ...
          <img className="seperat-line-efxqDX seperat-line" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/seperat-line-11@1x.png`} alt="Seperat line" />
          <div className="ic_add-efxqDX ic_add">
            <img className="add-nPxmxE" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/add@1x.png`} alt="Add" />
            <img className="ic_add-nPxmxE ic_add" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/ic-add@1x.png`} alt="ic_add" />
          </div>
          <div className="drop-down-list-efxqDX">
            <div className="ic_arrow_drop_down-gw8q3Y ic_arrow_drop_down">
              <img
                ...
                src={`${process.env.PUBLIC_URL}/img/challengeCompleted/ic-arrow-drop-down@1x.png`}
            ...
            <div className="drop-down-_options-gw8q3Y">
              ...
              <img className="seperat-line-VGCwkP seperat-line" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/seperat-line-10@1x.png`} alt="Seperat line" />
              <img className="seperat-line-lSZ49y seperat-line" src={`${process.env.PUBLIC_URL}/img/challengeCompleted/seperat-line-10@1x.png`} alt="Seperat line" />
          ...
          <a href="javascript:history.back()">
            <div className="icon-arrow-left-efxqDX icon-arrow-left">
              <img
                ...
                src={`${process.env.PUBLIC_URL}/img/challengeCompleted/icon-arrow-left-12@1x.png`}
                alt="icon-arrow-left"
              /></div
  ></a>
  </div>*/}
