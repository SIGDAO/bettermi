...
export async function BuyNft(Wallet:any,ledger2:any,nftId:string,nftPrice:string,userAccountId:string,codeHashIdForNft:string,nftDistributor:string,nftDistributorPublicKey:string,nftDistributorPrivateKey:string,userAccountPublicKey:string){
